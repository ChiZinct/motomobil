  ...
  <div class="content-wrapper">
   ...
   $pelanggan = mysqli_fetch_array($sql_pelangan);
     ...
     <?php
       ...
       $id = mysqli_query($conn, "SELECT MAX(MID(invoice_pembayaran, 33, 4)) as invoice_no FROM tb_pmbyranPelanggan WHERE MID(invoice_pembayaran, 15, 6) = DATE_FORMAT(CURDATE(), '%y%m%d') AND MID(invoice_pembayaran, 12, 2) = '".$id_gudang."' AND MID(invoice_pembayaran, 22, 10) = '".$invoice_penjualan."'");
       ...
       $prefix = "MD/PMB-PJL/".$id_gudang."/".date("ymd")."/".$invoice_penjualan."/";
    ...
    $('#pay').click(function(e){
      ...
      var valid = this.form.checkValidity();
        ...
        if(valid){
          ...
          $.ajax({
              type: 'POST',
              url: '../dataPembayaran/prosesPembayaran.php',
              ...
              success: function(data){
                 Swal.fire({
                  ...
                  window.location.href = 'tablePenjualan.php';
               })
              },
              error: function(data){
                    Swal.fire({
