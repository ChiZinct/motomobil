        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pilih Daerah</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Pilih Daerah</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="prosesPilihDaerah.php">
                <div class="card-body">
                  <div class="form-group row">
                     <div class="col">
                        ...
                        <select class="custom-select" name="daerah" id="daerah">
                           ...
                           $sql_daerah = mysqli_query($conn, "SELECT * FROM tb_daerah WHERE nama_salesman = '".$nama_salesman."'");
                ...
                <div class="card-footer text-center">
                    <input type="submit" class="btn btn-primary" name="choose" id="choose" value="Choose">
                </div>
              </form>
          </div>
        </div>
