...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
      ...
      $id = mysqli_query($conn, "SELECT MAX(MID(no_invoice, 17, 4)) as invoice_no FROM tb_transferbarang WHERE MID(no_invoice, 10, 6) = DATE_FORMAT(CURDATE(), '%y%m%d') AND MID(no_invoice, 7, 2) = '".$id_gudang."'");
      ...
      $prefix = "MD/TB/".$id_gudang."/".date("ymd")."/";
                         ...
                         <div class="col-sm-7">
                           <select class="custom-select" name="gudang_tujuan" id="gudang_tujuan">
                              ...
                              while($gudang = mysqli_fetch_array($sql_gudang)) {
                                 if($gudang['id_gudang'] !== $login_as['id_gudang']) { ?>
