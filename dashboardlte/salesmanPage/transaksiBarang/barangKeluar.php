...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
      ...
      $id = mysqli_query($conn, "SELECT MAX(MID(no_invoice, 17, 4)) as invoice_no FROM tb_barangkeluar WHERE MID(no_invoice, 10, 6) = DATE_FORMAT(CURDATE(), '%y%m%d') AND MID(no_invoice, 7, 2) = '".$id_gudang."'");
      ...
      $prefix = "MD/BK/".$id_gudang."/".date("ymd")."/";
                   ...
                   <div class="form-horizontal">
                     <div class="card-body">
                       <div class="form-group row">
                         ...
                         <div class="col-sm-7">
                            <input type="text" class="form-control" id="keluar_dari" name="keluar_dari" value="<?php echo $login_as['id_gudang'] ?>" readonly>
                         </div>
                       </div>
                       <div class="form-group row">
