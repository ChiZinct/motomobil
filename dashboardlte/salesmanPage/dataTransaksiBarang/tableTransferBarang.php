        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Daftar Transfer Barang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                           $sql_transfer_barang = mysqli_query($conn, "SELECT * FROM tb_transferbarang WHERE gudang_asal = '".$login_as['id_gudang']."' OR gudang_tujuan = '".$login_as['id_gudang']."'") or die(mysqli_error($conn));
                           while($transfer_barang = mysqli_fetch_array($sql_transfer_barang)){
                              if($transfer_barang['gudang_asal'] !== $login_as['id_gudang']) {
                              ?>
                              <tr>
                                       <td><?php echo $transfer_barang['no_invoice']?></td>
                                       <td><?php echo $transfer_barang['tanggal']?></td>
                                       <td><?php echo $transfer_barang['gudang_asal'] ?></td>
                                       <td><?php echo $transfer_barang['gudang_tujuan'] ?></td>
                                       <td><?php echo $transfer_barang['keterangan']?></td>
                                       <td>
                                       </td>
                                    </tr>
                           <?php
                              ...
                              <tr>
                                       ...
                                       <td><?php echo $transfer_barang['keterangan']?></td>
                                       <td>
                                          <a href="editTransferBarang.php?id=<?php echo $transfer_barang['no_invoice']?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                                          <a href="javascript:deleteDataTransaksi(`<?php echo $transfer_barang['no_invoice']?>`)" class="btn btn-danger btn-sm">
...
function deleteDataTransaksi(id){
   Swal.fire({
     ...
     if (result.isConfirmed) {
        window.location.href='deleteTransferBarang.php?id='+id;
       Swal.fire(
         'Deleted!',
