...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <?php
      $query_barangKeluar = mysqli_query($conn, "SELECT * FROM tb_barangkeluar WHERE no_invoice = '".$_GET['id']."'");
                   ...
                   <div class="form-horizontal">
                     <div class="card-body">
                       <div class="form-group row">
                         ...
                         <div class="col-sm-8">
                           <input type="text" class="form-control" name="no_invoice" id="no_invoice" placeholder="No. Transaksi" value="<?php echo $barang_keluar['no_invoice'] ?>" readonly>
                         </div>
                       </div>
                       <div class="form-group row">
                         ...
                         <div class="col-sm-8">
                           <div class='input-group date' id='datepicker'>
                               <input type='text' class="form-control" id="tanggal" name="tanggal" id="tanggal" placeholder="Tanggal" value="<?php echo $barang_keluar['tanggal'] ?>" required>
                   ...
                   <div class="form-horizontal">
                     <div class="card-body">
                       <div class="form-group row">
                         ...
                         <div class="col-sm-7">
                            <?php
                            $sql_gudang = mysqli_query($conn, "SELECT * FROM tb_user WHERE username = '".$_SESSION['username']."'") or die(mysqli_error($conn));
                            $gudang = mysqli_fetch_array($sql_gudang);
                             ?>
                            <input type="text" class="form-control" id="keluar_dari" name="keluar_dari" value="<?php echo $gudang['id_gudang'] ?>" readonly>
                         </div>
                       </div>
                       <div class="form-group row">
    ...
    $('#update').click(function(e){
      ...
      var valid = this.form.checkValidity();
        ...
        if(valid){
          ...
          $.ajax({
              type: 'POST',
              url: 'updateBarangKeluar.php?id='+no_invoice,
              ...
              success: function(data){
                 Swal.fire({
                  ...
                  window.location.href = 'tableBarangKeluar.php';
