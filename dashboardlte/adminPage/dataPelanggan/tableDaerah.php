            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                           $sql_daerah = mysqli_query($conn, "SELECT * FROM tb_daerah") or die(mysqli_error($conn));
                           while($daerah = mysqli_fetch_array($sql_daerah)){
                        ?>
                        <tr>
                           <td><?php echo $daerah['id_daerah'] ?></td>
                           <td><?php echo $daerah['nama_daerah'] ?></td>
                           <td><?php echo $daerah['nama_salesman'] ?></td>
                           <td>
                              <a href="editDaerah.php?id=<?php echo $daerah['id_daerah'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                              <a href="javascript:deleteDaerah(`<?php echo $daerah['id_daerah'] ?>`)" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                           </td>
                        </tr>
                        <?php } ?>
                  </tbody>
...
function deleteDaerah(id){
   Swal.fire({
     ...
     if (result.isConfirmed) {
        window.location.href='deleteDaerah.php?id='+id;
       Swal.fire(
         'Deleted!',
