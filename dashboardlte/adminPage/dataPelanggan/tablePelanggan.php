        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="tablePelanggan.php" class="nav-link active">
                  <i class="nav-icon fas fa-table"></i>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tr>
                     <?php // TODO: Lanjutkan membuat table Pelanggan ?>
                     <th>ID Pelanggan</th>
                  ...
                  <tbody>
                        <?php
                           $sql_pelanggan = mysqli_query($conn, "SELECT * FROM tb_pelanggan") or die(mysqli_error($conn));
                        ...
                        <tr>
                           ...
                           <td><?php echo $pelanggan['nama_salesman'] ?></td>
                           <td>
                              <a href="editPelanggan.php?id=<?php echo $pelanggan['id_pelanggan'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                              <a href="javascript:deletePelanggan(`<?php echo $pelanggan['id_pelanggan'] ?>`)" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                           </td>
                        </tr>
                        <?php } ?>
                  </tbody>
...
function deletePelanggan(id){
   Swal.fire({
     ...
     if (result.isConfirmed) {
        window.location.href='deletePelanggan.php?id='+id;
       Swal.fire(
         'Deleted!',
