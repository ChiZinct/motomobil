...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="tambahPelanggan.php" class="nav-link">
                  <i class="nav-icon fas fa-plus"></i>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <?php
    $id   = mysqli_query($conn, "SELECT MAX(MID(id_daerah, 4, 3)) as id_daerah FROM tb_daerah");
       if(mysqli_num_rows($id) > 0) {
         $data = mysqli_fetch_array($id);
         $angka = (int)$data['id_daerah'] + 1;
       } else {
         $angka = "001";
       }
     $prefix = "DRH";
     $id_daerah = $prefix.sprintf("%03s", $angka);
     ?>
                ...
                <div class="card-body">
                  <div class="form-group row">
                     <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="id_daerah" id="id_daerah" value="<?php echo $id_daerah ?>" readonly>
                     </div>
                     <div class="col-md-4">
                        <label for="nama_daerah">Nama Daerah</label>
                        <input type="text" class="form-control" name="nama_daerah" id="nama_daerah" placeholder="Nama Daerah" required>
                     </div>
                     <div class="col-md-4">
    ...
    $('#submit').click(function(e){
      ...
      var valid = this.form.checkValidity();
        ...
        if(valid){
          ...
          var nama_daerah = $('#nama_daerah').val();
          ...
          $.ajax({
              type: 'POST',
              url: 'prosesDaerah.php',
              data: {id_daerah: id_daerah, nama_daerah: nama_daerah, nama_salesman: nama_salesman},
              success: function(data){
                 Swal.fire({
                  ...
                  confirmButtonText: `<a style="color: white;" href="tableDaerah.php">Go To Table Daerah</a>`,
                  denyButtonText: `<a style="color: white;" href="tambahDaerah.php">Insert Another Form</a>`,
                  })
              },
              error: function(data){
                    Swal.fire({
