...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <?php
    $sql_pelanggan = mysqli_query($conn, "SELECT * FROM tb_pelanggan WHERE id_pelanggan = '".$_GET['id']."'");
                ...
                <div class="card-body">
                  <div class="form-group row">
                     <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="id_pelanggan" id="id_pelanggan" value="<?php echo $pelanggan['id_pelanggan'] ?>" readonly>
                     </div>
                     <div class="col-md-6">
                        <label for="nama_pelanggan">Nama Pelangan</label>
                        <input type="text" class="form-control" name="nama_pelanggan" id="nama_pelanggan" value="<?php echo $pelanggan['nama_pelanggan'] ?>" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <div class="col-md-12">
                        <label for="alamat">Alamat</label>
                        <input type="text" class="form-control" name="alamat" id="alamat" value="<?php echo $pelanggan['alamat'] ?>" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="no_telp" id="no_telp" value="<?php echo $pelanggan['no_telp'] ?>" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <div class="col-md-6">
    ...
    $('#update').click(function(e){
      ...
      var valid = this.form.checkValidity();
        ...
        if(valid){
          ...
          $.ajax({
              type: 'POST',
              url: 'updatePelanggan.php?id='+id_pelanggan,
              ...
              success: function(data){
                 Swal.fire({
                  ...
                  window.location.href = 'tablePelanggan.php';
