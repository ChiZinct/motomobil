          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edit Daerah</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                  <div class="form-group row">
                     <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="id_daerah" id="id_daerah" value="<?php echo $daerah['id_daerah'] ?>" readonly>
                     </div>
                     <div class="col-md-4">
                        <label for="nama_daerah">Nama Daerah</label>
                        <input type="text" class="form-control" name="nama_daerah" id="nama_daerah" value="<?php echo $daerah['nama_daerah'] ?>" required>
                     </div>
                     <div class="col-md-4">
                        <label for="nama_salesman">Nama Salesman</label>
                        <select class="custom-select" name="nama_salesman" id="nama_salesman">
                           <option><?php echo $daerah['nama_salesman'] ?></option>
                           <?php
                           $sql_salesman = mysqli_query($conn, "SELECT * FROM tb_user WHERE acc_type = 'Salesman'");
                           while($salesman = mysqli_fetch_array($sql_salesman)) {
                              if($salesman['nama_depan']." ".$salesman['nama_belakang'] !== $daerah['nama_salesman']) {
                            ?>
    ...
    $('#submit').click(function(e){
      ...
      var valid = this.form.checkValidity();
        ...
        if(valid){
          ...
          $.ajax({
              type: 'POST',
              url: 'updateDaerah.php?id='+id_daerah,
              ...
              success: function(data){
                 Swal.fire({
                  ...
                  window.location.href = 'tableDaerah.php';
