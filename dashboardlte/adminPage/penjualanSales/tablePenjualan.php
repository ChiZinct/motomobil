      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
             ...
             <?php
             $sql_salesman = mysqli_query($conn, "SELECT * FROM tb_user WHERE user_id = '".$_GET['id']."'");
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  Nama Salesman: <strong><?php echo $salesman['nama_depan']." ".$salesman['nama_belakang'] ?></strong>
                </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                           ...
                           $sql_penjualan = mysqli_query($conn, "SELECT * FROM tb_penjualan WHERE nama_salesman = '".$nama_salesman."' ORDER BY tanggal DESC") or die(mysqli_error($conn));
                           while($penjualan = mysqli_fetch_array($sql_penjualan)){
                              ...
                              <tr>
                                       ...
                                       <td class="text-right">
                                          <?php if($penjualan['status'] === "Belum Lunas") { ?>
                                          <a href="bayarPenjualan.php?id=<?php echo $penjualan['no_invoice'] ?>" class="btn btn-success btn-sm"><i class="fa-solid fa-hand-holding-dollar"></i></a>
                                          <a href="editPenjualan.php?id=<?php echo $penjualan['no_invoice'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                                          <a href="javascript:deletePenjualan(`<?php echo $penjualan['no_invoice']?>`)" class="btn btn-danger btn-sm">
