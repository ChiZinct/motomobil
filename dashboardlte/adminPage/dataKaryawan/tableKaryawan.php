        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="tableKaryawan.php" class="nav-link active">
                  <i class="nav-icon fas fa-table"></i>
              ...
              <div class="card-body">
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th>Uang Hadir</th>
                    <th>Uang Makan</th>
                    <th>Uang Hari Besar</th>
                    <th style="width:50px">Action</th>
                  </tr>
                  </thead>
                  <tbody>
                     <?php
                      $sql_karyawan = mysqli_query($conn, "SELECT * FROM tb_karyawan") OR DIE(mysqli_error($conn));
                      while($karyawan = mysqli_fetch_array($sql_karyawan)){
                      ?>
                    <tr>
                       <td><?php echo $karyawan['nama_karyawan'] ?></td>
                       <td><?php echo $karyawan['tempat_lahir'].", ".$karyawan['tgl_lahir'] ?></td>
                       <td><?php echo $karyawan['nik'] ?></td>
                       <td><?php echo $karyawan['jabatan'] ?></td>
                       <td><?php echo $karyawan['masa_kerja'] ?></td>
                       <td><?php echo rupiah($karyawan['gaji_pokok']) ?></td>
                       <td><?php echo rupiah($karyawan['tunj_jabatan']) ?></td>
                       <td><?php echo rupiah($karyawan['premi']) ?></td>
                       <td><?php echo rupiah($karyawan['uang_hadir']) ?></td>
                       <td><?php echo rupiah($karyawan['uang_makan']) ?></td>
                       <td><?php echo rupiah($karyawan['uang_hari_besar']) ?></td>
                       <td>
                          <a href="editKaryawan.php?id=<?php echo $karyawan['nik'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                           <a href="javascript:deleteKaryawan(`<?php echo $karyawan['nik'] ?>`)" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                       </td>
                    </tr>
                  </tbody>
               <?php } ?>
