      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="tambahKaryawan.php" class="nav-link active">
                  <i class="nav-icon fas fa-plus"></i>
                  <p>Tambah Data Baru</p>
                </a>
              </li>
              ...
              <form>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class='input-group date' id='datepicker1'>
                        <input type='text' class="form-control" name="tgl_lahir" id="tgl_lahir" name="tgl_lahir" placeholder="Tanggal Lahir" required>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" name="nik" id="nik" maxlength="16" placeholder="Nomor Identitas Kependudukan"
                ...
                <div class="col-lg-6">
                  ...
                  <div class='input-group date' id='datepicker2'>
                      <input type="text" class="form-control" name="masa_kerja" id="masa_kerja" name="masa_kerja" placeholder="Masa Kerja" required>
                      <span class="input-group-addon">
                      </span>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="tunj_jabatan" id="tunj_jabatan">
                    </div>
                  </div>
                  <div class="col-md-4">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="premi" id="premi">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-md-4">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="uang_hadir" id="uang_hadir">
                    </div>
                  </div>
                  <div class="col-md-4">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="uang_makan" id="uang_makan">
                    </div>
                  </div>
                  <div class="col-md-4">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="uang_hari_besar" id="uang_hari_besar">
                    </div>
                  </div>
                </div>
                </div>
                ...
                <div class="card-footer">
                    ...
                    <input type="submit" class="btn btn-secondary" name="clear" id="clear" value="Clear" onclick="javascript:reset();">
                </div>
              </form>
          </div>
        </div>
    ...
    $('#submit').click(function(e){
      ...
      var valid = this.form.checkValidity();
        ...
        if(valid){
          ...
          $.ajax({
              ...
              success: function(data){
                    Swal.fire({
                      ...
                      text: data,
                      icon: 'success',
                      confirmButtonText:`<a style="color: white;" href="tambahKaryawan.php">OK</a>`
                    })
              },
              error: function(data){
                    Swal.fire({
          ...
          document.getElementById("nama_karyawan").reset();
          document.getElementById("tempat_lahir").reset();
          document.getElementById("tgl_lahir").reset();
          document.getElementById("nik").reset();
          document.getElementById("jabatan").reset();
          document.getElementById("masa_kerja").reset();
          document.getElementById("gaji_pokok").reset();
          document.getElementById("tunj_jabatan").reset();
          document.getElementById("premi").reset();
          document.getElementById("uang_hadir").reset();
          document.getElementById("uang_makan").reset();
          document.getElementById("uang_hari_besar").reset();
        }
    });
  });
</script>
