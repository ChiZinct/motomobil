                ...
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        ...
                        <tr>
                                       ...
                                       <td>
                                          <a href="editJabatan.php?id=<?php echo $jabatan['nama_jabatan'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                                           <a href="javascript:deleteJabatan(`<?php echo $jabatan['nama_jabatan'] ?>`)" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                                       </td>
                                    </tr>
                           <?php } ?>
                  </tbody>
