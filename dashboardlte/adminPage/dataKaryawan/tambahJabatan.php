        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="tambahJabatan.php" class="nav-link active">
                  <i class="nav-icon fas fa-plus"></i>
                  <p>Tambah Jabatan</p>
                </a>
              </li>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="prosesJabatan.php">
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-md-12">
                      <label for="nama_depan">Nama Jabatan</label>
                      <input type="text" class="form-control" name="nama_jabatan" id="nama_jabatan" placeholder="Ex: Kepala Distributor" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
  ...
  $(function(){
    $('#submit').click(function(e){
      ...
      var valid = this.form.checkValidity();
          ...
          $.ajax({
              ...
              success: function(data){
                    Swal.fire({
                      ...
                      text: data,
                      icon: 'success',
                      confirmButtonText:`<a style="color: white;" href="tambahJabatan.php">OK</a>`
                    })
              },
              error: function(data){
                    Swal.fire({
        ...
        document.getElementById("nama_jabatan").reset();
        }
    });
  });
</script>
