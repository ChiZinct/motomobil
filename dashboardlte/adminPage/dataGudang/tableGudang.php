                ...
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        ...
                        <tr>
                                       ...
                                       <td><?php echo $gudang['nama_depan']." ".$gudang['nama_belakang'] ?></td>
                                       <td>
                                          <a href="lihatGudang.php?id=<?php echo $gudang['id_gudang'] ?>" class="btn btn-success btn-sm"><i class="fas fa-eye"></i></a>
                                       </td>
                                    </tr>
                           <?php } ?>
                  </tbody>
