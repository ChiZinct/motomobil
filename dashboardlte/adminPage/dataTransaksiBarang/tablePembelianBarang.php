            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                           $sql_pembelian_barang = mysqli_query($conn, "SELECT * FROM tb_pembelian") or die(mysqli_error($conn));
                           while($pembelian_barang = mysqli_fetch_array($sql_pembelian_barang)){
                              ?>
                              <tr>
                                       <td><?php echo $pembelian_barang['no_invoice']?></td>
                                       <td><?php echo $pembelian_barang['tanggal']?></td>
                                       <td><?php echo $pembelian_barang['supplier'] ?></td>
                                       <td><?php echo $pembelian_barang['no_plat']?></td>
                                       <td><?php echo rupiah($pembelian_barang['total_pembelian'])?></td>
                                       <td>
                                          <a href="editPembelianBarang.php?id=<?php echo $pembelian_barang['no_invoice'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                                          <a href="javascript:deleteDataTransaksi(`<?php echo $pembelian_barang['no_invoice']?>`)" class="btn btn-danger btn-sm">
...
function deleteDataTransaksi(id){
   Swal.fire({
     ...
     if (result.isConfirmed) {
        window.location.href='deletePembelian.php?id='+id;
       Swal.fire(
         'Deleted!',
