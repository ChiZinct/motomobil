            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                           $sql_barang_keluar = mysqli_query($conn, "SELECT * FROM tb_barangkeluar") or die(mysqli_error($conn));
                           while($barang_keluar = mysqli_fetch_array($sql_barang_keluar)){
                              ?>
                              <tr>
                                       <td><?php echo $barang_keluar['no_invoice']?></td>
                                       <td><?php echo $barang_keluar['tanggal']?></td>
                                       <td><?php echo $barang_keluar['keluar_dari'] ?></td>
                                       <td><?php echo $barang_keluar['keterangan']?></td>
                                       <td>
                                          <a href="editBarangKeluar.php?id=<?php echo $barang_keluar['no_invoice'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                                          <a href="javascript:deleteDataTransaksi(`<?php echo $barang_keluar['no_invoice']?>`)" class="btn btn-danger btn-sm">
...
function deleteDataTransaksi(id){
   Swal.fire({
     ...
     if (result.isConfirmed) {
        window.location.href='deleteBarangKeluar.php?id='+id;
       Swal.fire(
         'Deleted!',
