...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../transaksiBarang/pembelianBarang.php" class="nav-link active">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="tablePembelianBarang.php" class="nav-link">
                  <i class="nav-icon fas fa-table"></i>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Pembelian Barang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
    <?php
    $query_pembelian = mysqli_query($conn, "SELECT * FROM tb_pembelian WHERE no_invoice = '".$_GET['id']."'");
                ...
                <div class="form-horizontal">
                  <div class="card-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="no_invoice" id="no_invoice" value="<?php echo $pembelian['no_invoice'] ?>" readonly >
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <div class='input-group date' id='datepicker'>
                            <input type='text' class="form-control" id="tanggal" name="tanggal" value="<?php echo $pembelian['tanggal'] ?>" >
            ...
            <div class="col-md-12">
              <div class="card card-primary">
                <div class="form-horizontal">
                  <div class="card-body">
                    <div class="form-group row">
                      <label for="nama_supplier" class="col-sm-5 col-form-label">Beli Dari</label>
                      <div class="col-sm-7">
                        <select class="custom-select" id="supplier" name="supplier">
                           <option>
                              <?php echo $pembelian['supplier'] ?>
                           </option>
                           <?php
                              $sql_supplier = mysqli_query($conn, "SELECT * FROM tb_supplier") or die(mysqli_error($conn));
                              while($supplier = mysqli_fetch_array($sql_supplier)) {
                                 if($supplier['nama_supplier'] !== $pembelian['supplier']) {
                            ?>
                          <option>
                    ...
                    <div class="form-group row">
                      <label for="no_plat" class="col-sm-5 col-form-label">No. Plat Mobil</label>
                      <div class="col-sm-7">
                        <input type="text" class="form-control" id="no_plat" name="no_plat" value="<?php echo $pembelian['no_plat'] ?>">
                      </div>
                    </div>
                  </div>
               </div>
            ...
            <div class="card">
              <div class="card-body">
                <table id="tablePembelian" class="table table-bordered table-hover">
                  ...
                  <tbody>
                     <?php
                     $sql_transaksi = mysqli_query($conn, "SELECT * FROM tb_transaksi WHERE no_invoice = '".$pembelian['no_invoice']."'") or die(mysqli_error($conn));
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <h3 style="text-align: right"><b>
                     <?php
                        $sql_total_harga = mysqli_query($conn, 'SELECT SUM(`total_harga_satuan`) AS `total_harga` FROM `tb_transaksi` WHERE `no_invoice` = \''. mysqli_escape_string($conn, $pembelian['no_invoice']).'\'');
    ...
    $('#update').click(function(e){
      ...
      var valid = this.form.checkValidity();
        ...
        if(valid){
          ...
          $.ajax({
              type: 'POST',
              url: 'updatePembelian.php?id='+no_invoice,
              data: {no_invoice: no_invoice, tanggal: tanggal, supplier: supplier, no_plat: no_plat, total_pembelian: total_pembelian},
              success: function(data){
                 Swal.fire({
                  position: 'top-end',
                  icon: 'success',
                  ...
                  window.location.href = 'tablePembelianBarang.php';
