...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <?php
      $query_barangMasuk = mysqli_query($conn, "SELECT * FROM tb_barangmasuk WHERE no_invoice = '".$_GET['id']."'");
                   ...
                   <div class="form-horizontal">
                     <div class="card-body">
                       <div class="form-group row">
                         ...
                         <div class="col-sm-8">
                           <input type="text" class="form-control" id="no_invoice" name="no_invoice" placeholder="No. Transaksi" value="<?php echo $barang_masuk['no_invoice'] ?>" readonly>
                         </div>
                       </div>
                       <div class="form-group row">
                         ...
                         <div class="col-sm-8">
                           <div class='input-group date' id='datepicker'>
                               <input type='text' class="form-control" id="tanggal" name="tanggal" placeholder="Tanggal" value="<?php echo $barang_masuk['tanggal'] ?>" required>
               ...
               <div class="col-md-12">
                 <div class="card card-primary">
                   <div class="form-horizontal">
                     <div class="card-body">
                        <div class="form-group row">
                         <label for="masuk_dari" class="col-sm-5 col-form-label">Gudang Tujuan</label>
                         <div class="col-sm-7">
                           <input type="text" class="form-control" id="masuk_dari" name="masuk_dari" value="<?php echo $barang_masuk['masuk_dari'] ?>" readonly>
                         </div>
                       </div>
                       <div class="form-group row">
                         <label for="masuk_ke" class="col-sm-5 col-form-label">Gudang Tujuan</label>
                         <div class="col-sm-7">
                           <input type="text" class="form-control" id="masuk_ke" name="masuk_ke" value="<?php echo $barang_masuk['masuk_ke'] ?>" readonly>
                         </div>
                       </div>
                       <div class="form-group row">
                         <label for="keterangan" class="col-sm-5 col-form-label">Keterangan</label>
                         <div class="col-sm-7">
                           <input type="text" class="form-control" id="keterangan" name="keterangan" value="<?php echo $barang_masuk['keterangan'] ?>">
                         </div>
                       </div>
                     </div>
                  </div>
    ...
    $('#update').click(function(e){
      ...
      var valid = this.form.checkValidity();
        ...
        if(valid){
          ...
          $.ajax({
              type: 'POST',
              url: 'updateBarangMasuk.php?id='+no_invoice,
              data: {no_invoice: no_invoice, tanggal: tanggal, masuk_dari: masuk_dari, keterangan: keterangan},
              success: function(data){
                 Swal.fire({
                  position: 'top-end',
                  icon: 'success',
                  ...
                  window.location.href = 'tableBarangMasuk.php';
