            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                           $sql_barang_masuk = mysqli_query($conn, "SELECT * FROM tb_barangmasuk") or die(mysqli_error($conn));
                           while($barang_masuk = mysqli_fetch_array($sql_barang_masuk)){
                              ?>
                              <tr>
                                       <td><?php echo $barang_masuk['no_invoice']?></td>
                                       <td><?php echo $barang_masuk['tanggal']?></td>
                                       <td><?php echo $barang_masuk['masuk_dari'] ?></td>
                                       <td><?php echo $barang_masuk['keterangan']?></td>
                                       <td>
                                          <a href="editBarangMasuk.php?id=<?php echo $barang_masuk['no_invoice'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                                          <a href="javascript:deleteDataTransaksi(`<?php echo $barang_masuk['no_invoice']?>`)" class="btn btn-danger btn-sm">
...
function deleteDataTransaksi(id){
   Swal.fire({
     ...
     if (result.isConfirmed) {
        window.location.href='deleteBarangMasuk.php?id='+id;
       Swal.fire(
         'Deleted!',
