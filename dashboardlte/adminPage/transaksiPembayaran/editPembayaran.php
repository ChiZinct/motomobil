...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="tambahPembayaran.php" class="nav-link">
                  <i class="nav-icon fas fa-plus"></i>
                  <p>Tambah Data Baru</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="tablePembayaran.php" class="nav-link">
                  <i class="nav-icon fas fa-table"></i>
                  <p>Pembayaran Ke Supplier</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="tablePembayaranPelanggan.php" class="nav-link">
                  <i class="nav-icon fas fa-table"></i>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <?php
    $query_pembayaran = mysqli_query($conn, "SELECT * FROM tb_pembayaran WHERE no_invoice = '".$_GET['id']."'");
            ...
            <div class="card card-secondary">
              ...
              <form>
                <div class="card-body">
                  <div class="form-group row">
                     <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="no_invoice" id="no_invoice" value="<?php echo $pembayaran['no_invoice'] ?>" readonly>
                     </div>
                     <div class="col-md-6">
                        <label for="tanggal">Tanggal</label>
                        <div class='input-group date' id='datepicker'>
                            <input type='text' class="form-control" id="tanggal" name="tanggal" placeholder="Tanggal" value="<?php echo $pembayaran['tanggal'] ?>" >
                     ...
                     <div class="col">
                        <label for="jumlah_pembayaran">Jumlah Pembayaran</label>
                           <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="jumlah_pembayaran" id="jumlah_pembayaran" value="<?php echo rupiah($pembayaran['jumlah_pembayaran']) ?>">
                           </div>
                     </div>
                  </div>
                ...
                <div class="card-footer">
                    ...
                    <input type="button" class="btn btn-secondary" name="resetForm" id="resetForm" value="Reset" onclick="this.form.reset();">
                </div>
              </form>
    ...
    $('#update').click(function(e){
      ...
      var valid = this.form.checkValidity();
        ...
        if(valid){
          ...
          $.ajax({
              type: 'POST',
              url: 'updatePembayaran.php?id='+no_invoice,
              data: {no_invoice: no_invoice, tanggal: tanggal, jumlah_pembayaran: jumlah_pembayaran},
              success: function(data){
                 Swal.fire({
                  ...
                  window.location.href = 'tablePembayaran.php';
