            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                           $sql_pembayaran = mysqli_query($conn, "SELECT * FROM tb_pembayaran") or die(mysqli_error($conn));
                           while($pembayaran = mysqli_fetch_array($sql_pembayaran)){
                        ?>
                        <tr>
                                       <td><?php echo $pembayaran['no_invoice'] ?></td>
                                       <td><?php echo $pembayaran['tanggal'] ?></td>
                                       <td><?php echo rupiah($pembayaran['jumlah_pembayaran']) ?></td>
                                       <td>
                                          <a href="editPembayaran.php?id=<?php echo $pembayaran['no_invoice'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                                           <a href="javascript:deletePembayaran(`<?php echo $pembayaran['no_invoice'] ?>`)" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                                       </td>
                                    </tr>
                           <?php } ?>
                  </tbody>
...
function deletePembayaran(id){
   Swal.fire({
     ...
     if (result.isConfirmed) {
        window.location.href='deletePembayaran.php?id='+id;
       Swal.fire(
         'Deleted!',
