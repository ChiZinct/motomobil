...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <?php
    $id   = mysqli_query($conn, "SELECT MAX(MID(no_invoice, 15, 4)) as invoice_no FROM tb_pembayaran
    WHERE MID(no_invoice, 8, 6) = DATE_FORMAT(CURDATE(), '%y%m%d')");
          ...
          $.ajax({
              ...
              success: function(data){
                 Swal.fire({
                  ...
                  confirmButtonText: `<a style="color: white;" href="tablePembayaran.php">Go To Table Data Pembayaran</a>`,
                  denyButtonText: `<a style="color: white;" href="tambahPembayaran.php">Insert Another Form</a>`,
                  })
              },
              error: function(data){
                    Swal.fire({
