      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="tambahSupplier.php" class="nav-link">
                  <i class="nav-icon fas fa-plus"></i>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- form start -->
              <?php
              $query = mysqli_query($conn, "SELECT * FROM tb_supplier WHERE id_supplier ='".$_GET['id']."'");
              ...
              <form>
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" name="id_supplier" id="id_supplier" value="<?php echo $supplier['id_supplier'] ?>" readonly required>
                    </div>
                    <div class="col-md-6">
                        <label for="nama_supplier">Nama Supplier</label>
                        <input type="text" class="form-control" name="nama_supplier" id="nama_supplier" value="<?php echo $supplier['nama_supplier'] ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="no_telp1" id="no_telp1" value="<?php echo $supplier['no_telp1'] ?>" onkeypress="return numberInput(event)">
                  </div>
                  <div class="col-lg-6">
                    <label for="tgl_lahir">Nomor Telepon 2</label>
                    <input type="text" class="form-control" name="no_telp2" id="no_telp2" value="<?php echo $supplier['no_telp2'] ?>" onkeypress="return numberInput(event)" onkeyup="">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <input class="form-control" name="alamat" id="alamat" value="<?php echo $supplier['alamat'] ?>"></input>
                  </div>
                </div>
                </div>
                <!-- /.card-body -->
    ...
    $('#update').click(function(e){
      ...
      var valid = this.form.checkValidity();
        ...
        if(valid){
          ...
          $.ajax({
              type: 'POST',
              url: 'prosesEditSupplier.php?id='+id_supplier,
              ...
              success: function(data){
                 Swal.fire({
                  ...
                  window.location.href = 'tableSupplier.php';
               })
              },
              error: function(data){
                    Swal.fire({
