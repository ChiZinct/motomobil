        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="tableProdukJual.php" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Daftar Produk Jual</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                           $sql_produk_jual = mysqli_query($conn, "SELECT * FROM tb_barang WHERE jenis_barang = 'Produk Jual'") or die(mysqli_error($conn));
                           while($produk_jual = mysqli_fetch_array($sql_produk_jual)){
                              ?>
                              <tr>
                                       <td><?php echo $produk_jual['id_barang']?></td>
                                       <td><?php echo $produk_jual['nama_barang']?></td>
                                       <td><?php echo koma($produk_jual['berat_barang'])." ".$produk_jual['satuan_barang']?></td>
                                       <td><?php echo $produk_jual['satuan_jual']?></td>
                                       <td><?php echo rupiah($produk_jual['harga_beli'])?></td>
                                       <td><?php echo rupiah($produk_jual['harga_jual'])?></td>
                                       <td>
                                          <a href="editProdukJual.php?id=<?php echo $produk_jual['id_barang'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                                          <a href="javascript:deleteProdukJual(`<?php echo $produk_jual['id_barang']?>`)" class="btn btn-danger btn-sm">
...
function deleteProdukJual(id){
   Swal.fire({
     ...
     if (result.isConfirmed) {
        window.location.href='deleteProdukJual.php?id='+id;
       Swal.fire(
         'Deleted!',
