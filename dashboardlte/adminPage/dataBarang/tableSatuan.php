        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="tableSatuan.php" class="nav-link active">
                  <i class="nav-icon fas fa-table"></i>
                  <p>
                    Daftar Satuan
                  </p>
                ...
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                           ...
                           ?><tr>
                                       <td><?php echo $satuan['kode_satuan'] ?></td>
                                       <td><?php echo $satuan['nama_satuan'] ?></td>
                                       <td><a href="editSatuan.php?id=<?php echo $satuan['kode_satuan'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                                           <a href="deleteSatuan.php?id=<?php echo $satuan['kode_satuan'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                                       </td>
                                    </tr>
                           <?php }?>
