        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="prosesSatuan.php" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="kode_satuan">Kode Satuan</label>
                      <input type="text" class="form-control" id="kode_satuan" name="kode_satuan" placeholder="ex: Kg" required>
                    </div>
                    <div class="col-md-6">
                      <label for="nama_satuan">Nama Satuan</label>
                      <input type="text" class="form-control" id="nama_satuan" name="nama_satuan" placeholder="ex: Kilogram" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
    ...
    $('#submit').click(function(e){
      ...
      var valid = this.form.checkValidity();
        ...
        if(valid){
          ...
          $.ajax({
              type: 'POST',
              url: 'prosesSatuan.php',
              data: {kode_satuan: kode_satuan, nama_satuan: nama_satuan},
              success: function(data){
                    Swal.fire({
                      title: 'Successful',
                      text: data,
                      icon: 'success',
                      confirmButtonText:`<a style="color: white;" href="tambahSatuan.php">OK</a>`
                    })
              },
              error: function(data){
                    Swal.fire({
          ...
          document.getElementById("kode_satuan").reset();
          document.getElementById("nama_satuan").reset();
        }
    });
  });
</script>
...
<script type="text/javascript">
    function clearText(){
      document.getElementById("kode_satuan").value = "";
