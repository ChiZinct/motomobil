        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Hadiah</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <?php
                  ...
                  $hadiah = mysqli_fetch_array($query);

               ?>
              <form action="prosesEditHadiah.php?id=<?php echo $hadiah['id_barang'] ?>" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="id_barang">ID Barang</label>
                      <input type="text" class="form-control" name="id_barang" id="id_barang" value="<?php echo $hadiah['id_barang'] ?>" onkeyup="upperFunction()" required>
                    </div>
                    <div class="col-md-6">
                      <label for="nama_barang">Nama Barang</label>
                      <input type="text" class="form-control" name="nama_barang" id="nama_barang" value="<?php echo $hadiah['nama_barang'] ?>" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <label for="jenis_barang">Jenis Barang</label>
                      <select class="custom-select" name="jenis_barang" id="jenis_barang">
                        <option value="<?php echo $hadiah['jenis_barang'] ?>" selected><?php echo $hadiah['jenis_barang'] ?></option>
                ...
                <div class="form-group row">
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="berat_barang" id="berat_barang" value="<?php echo $hadiah['berat_barang'] ?>" required>
                  </div>
                  <div class="col-md-4">
                    <label for="satuan_barang">Satuan Barang</label>
                    <select class="custom-select" name="satuan_barang" id="satuan_barang">
                      <option><?php echo $hadiah['satuan_barang'] ?></option>
                      <?php
                      $sql_kodeSatuan = mysqli_query($conn, "SELECT * FROM tb_satuan") or die(mysqli_error());
                      while($kode_satuan = mysqli_fetch_array($sql_kodeSatuan)) {
                        if($kode_satuan['kode_satuan'] !== $hadiah['satuan_barang']) {
                       ?>
                  ...
                  <div class="col-md-4">
                    ...
                    <select class="custom-select" name="satuan_jual" id="satuan_jual">
                      <option><?php echo $hadiah['satuan_jual'] ?></option>

                      <?php
                      $sql_kodeSatuan = mysqli_query($conn, "SELECT * FROM tb_satuan") or die(mysqli_error());
                      while($kode_satuan = mysqli_fetch_array($sql_kodeSatuan)) {
                        if($kode_satuan['kode_satuan'] !== $hadiah['satuan_jual']) {
                       ?>
                       <option><?php echo $kode_satuan['kode_satuan'] ?></option>
                       <?php
                           }
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="harga_beli" id="harga_beli" value="<?php echo rupiah($hadiah['harga_beli']) ?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="harga_jual" id="harga_jual" value="<?php echo rupiah($hadiah['harga_jual']) ?>">
                    </div>
                  </div>
                </div>
                </div>
      ...
      function cancel(){
         Swal.fire({
           ...
           if (result.isConfirmed) {
             window.location.href='tableHadiah.php';
           }
         })
  }
</script>
