        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="tambahSatuan.php" class="nav-link active">
                  <i class="nav-icon fas fa-plus"></i>
                  <p>
                    Tambah Satuan
                  </p>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- form start -->
              <?php
               $query = mysqli_query($conn, "SELECT * FROM tb_satuan WHERE kode_satuan ='".$_GET['id']."'");
               $satuan = mysqli_fetch_array($query);
               ?>
              <form action="prosesEditSatuan.php?id=<?php echo $satuan['kode_satuan'] ?>" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="kode_satuan">Kode Satuan</label>
                      <input type="text" class="form-control" id="kode_satuan" name="kode_satuan" value="<?php echo $satuan['kode_satuan'] ?>" required>
                    </div>
                    <div class="col-md-6">
                      <label for="nama_satuan">Nama Satuan</label>
                      <input type="text" class="form-control" id="nama_satuan" name="nama_satuan" value="<?php echo $satuan['nama_satuan'] ?>" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
      ...
      function cancel(){
         Swal.fire({
           ...
           if (result.isConfirmed) {
             window.location.href='tableSatuan.php';
           }
         })
  }
</script>
