        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="tableHadiah.php" class="nav-link active">
                  <i class="nav-icon fas fa-table"></i>
                  <p>
                    Daftar Hadiah
                  </p>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Daftar Hadiah</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                           $sql_hadiah = mysqli_query($conn, "SELECT * FROM tb_barang WHERE jenis_barang = 'Hadiah'") or die(mysqli_error($conn));
                           while($hadiah = mysqli_fetch_array($sql_hadiah)){
                        ?>
                        <tr>
                                       <td><?php echo $hadiah['id_barang'] ?></td>
                                       <td><?php echo $hadiah['nama_barang'] ?></td>
                                       <td><?php echo koma($hadiah['berat_barang'])." ".$hadiah['satuan_barang'] ?></td>
                                       <td><?php echo $hadiah['satuan_jual'] ?></td>
                                       <td><?php echo rupiah($hadiah['harga_beli']) ?></td>
                                       <td>
                                          <a href="editHadiah.php?id=<?php echo $hadiah['id_barang'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                                           <a href="javascript:deleteHadiah(`<?php echo $hadiah['id_barang'] ?>`)" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                                       </td>
                                    </tr>
...
function deleteHadiah(id){
   Swal.fire({
     ...
     if (result.isConfirmed) {
        window.location.href='deleteHadiah.php?id='+id;
       Swal.fire(
         'Deleted!',
