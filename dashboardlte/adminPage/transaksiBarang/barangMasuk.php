...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <?php
      $id = mysqli_query($conn, "SELECT MAX(MID(no_invoice, 18, 4)) as invoice_no FROM tb_barangmasuk WHERE MID(no_invoice, 11, 6) = DATE_FORMAT(CURDATE(), '%y%m%d') AND MID(no_invoice, 7, 3) = '".$login_as['id_gudang']."'");
      ...
      $prefix = "MD/BM/".$login_as['id_gudang']."/".date("ymd")."/";
               ...
               <div class="col-md-12">
                 <div class="card card-primary">
                   <div class="form-horizontal">
                     <div class="card-body">
                       <div class="form-group row">
                         <label for="supplier" class="col-sm-5 col-form-label">Masuk Dari</label>
                         <div class="col-sm-7">
                   ...
                   <table id="tableBarangMasuk" class="table table-bordered table-hover">
                     ...
                     <tbody>
                       ...
                       <tr>
                         ...
                         <td><?php echo rupiah($barang_masuk['total_harga_satuan'])?></td>
