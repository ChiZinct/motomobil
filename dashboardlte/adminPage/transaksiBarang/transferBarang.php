...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tambah Transfer Barang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
    <?php
      $id = mysqli_query($conn, "SELECT MAX(MID(no_invoice, 18, 4)) as invoice_no FROM tb_transferbarang WHERE MID(no_invoice, 11, 6) = DATE_FORMAT(CURDATE(), '%y%m%d') AND MID(no_invoice, 7, 3) = '".$login_as['id_gudang']."'");
      ...
      $prefix = "MD/TB/".$login_as['id_gudang']."/".date("ymd")."/";
                   ...
                   <div class="form-horizontal" action="#" method="post">
                     <div class="card-body">
                       <div class="form-group row">
                         ...
                         <div class="col-sm-7">
                           <select class="custom-select" name="gudang_asal" id="gudang_asal">
                              <?php
               ...
               <div class="card">
                 <div class="card-body">
                   <table id="example2" class="table table-bordered table-hover">
                     ...
                     <tbody>
                        <?php
                        $sql_transferBarang = mysqli_query($conn, 'SELECT * FROM `tb_transaksi` WHERE `no_invoice` = \''.mysqli_escape_string($conn, $no_invoice).'\'') or die(mysqli_error($conn));
                        while($transfer_barang = mysqli_fetch_array($sql_transferBarang)) {
                           $id_barang = $transfer_barang['id_barang'];
                         ...
                         ?>
                       <tr>
                         <td><?php echo $transfer_barang['id_barang'] ?></td>
                         <td><?php echo $barang['nama_barang'] ?></td>
                         <td><?php echo $transfer_barang['qty'] ?></td>
                         <td><?php echo $transfer_barang['satuan'] ?></td>
                         <td><?php echo rupiah($barang['harga_beli']) ?></td>
                         <td><?php echo rupiah($transfer_barang['total_harga_satuan']) ?></td>
                         <td><a href="javascript:deleteTransaksi(`<?php echo $transfer_barang['id_barang'].$transfer_barang['no_invoice']?>`)" class="btn btn-danger btn-sm">
           ...
           <div class="row">
            <div class="col-lg-12">
               <div class="col text-right">
                 ...
                 <a class="btn btn-danger btn btn-md" name="clear_all" href="javascript:clearAll(`<?php echo $no_invoice ?>`)">
                ...
                $.ajax({
                    ...
                    success: function(data){
                       Swal.fire({
                        ...
                        confirmButtonText: `<a style="color: white;" href="../dataTransaksiBarang/tableTransferBarang.php">Go To Table Transfer Barang</a>`,
                        denyButtonText: `<a style="color: white;" href="transferBarang.php">Insert Another Form</a>`,
                        })
                    },
                    error: function(data){
                          Swal.fire({
