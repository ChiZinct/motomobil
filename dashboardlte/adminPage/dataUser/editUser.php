        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- form start -->
              <?php
              $query_user = mysqli_query($conn, "SELECT * FROM tb_user WHERE user_id = '".$_GET['id']."'");
              ...
              <form>
                <div class="card-body">
                  <div class="form-group row">
                     <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="nama_depan" id="nama_depan" value="<?php echo $user['nama_depan'] ?>" required>
                     </div>
                     <div class="col-md-6">
                        <label for="nama_belakang">Nama Belakang</label>
                        <input type="text" class="form-control" id="nama_belakang" name="nama_belakang" value="<?php echo $user['nama_belakang'] ?>" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <div class="col-md-6">
                     <label for="tgl_lahir">Tanggal Lahir</label>
                      <div class='input-group date' id='datepicker'>
                          <input type='text' class="form-control" id="tgl_lahir" name="tgl_lahir" value="<?php echo $user['tgl_lahir'] ?>" required>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" name="acc_type" id="acc_type" value="<?php echo $user['acc_type'] ?>" readonly>
                      </div>
                      <div class="col-md-6">
                ...
                <div class="card-footer">
                    <input type="submit" class="btn btn-primary" name="register" id="register" value="Update Account Information">
    ...
    $('#register').click(function(e){
      ...
      var valid = this.form.checkValidity();
        ...
        if(valid){
          ...
          $.ajax({
              type: 'POST',
              url: 'updateUser.php?id='+user_id,
              data: {nama_depan: nama_depan, nama_belakang: nama_belakang, tgl_lahir: tgl_lahir, no_telp: no_telp},
