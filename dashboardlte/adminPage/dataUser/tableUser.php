            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="table1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                           $sql_user = mysqli_query($conn, "SELECT * FROM tb_user") or die(mysqli_error($conn));
                        ...
                        <tr>
                                       ...
                                       <td>
                                          <a href="editUser.php?id=<?php echo $user['user_id'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                                           <a href="javascript:deleteUser(`<?php echo $user['user_id'] ?>`)" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                                       </td>
                                    </tr>
                           <?php } ?>
                  </tbody>
